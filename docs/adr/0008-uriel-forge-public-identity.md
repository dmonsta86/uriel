...
4. Restrict named online AI model recommendations in public documentation strictly to **GPT-5.6 Sol with ultra mode** accompanied by all required non-dependency and privacy disclaimers.
