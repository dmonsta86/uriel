# Uriel Forge hero prompt — English
...
Create a locale-specific ART-ONLY variation for English (en).
...
Locale adaptation:
Western/Mediterranean classical scholar-smith; retain the existing armored, wingless guardian and current forge symbolism.
...
```text
globalization/image_copy/en.json
```

## Output path after approval

```text
docs/assets/i18n/en/uriel-forge-hero.png
```
