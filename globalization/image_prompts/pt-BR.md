# Uriel Forge hero prompt — Português (Brasil)
...
Create a locale-specific ART-ONLY variation for Português (Brasil) (pt-BR).
...
Locale adaptation:
Diverse Luso-Brazilian guardian-smith with subtle modernist and Afro-Brazilian craft geometry; no carnival, colonial, football, or exoticized imagery.
...
```text
globalization/image_copy/pt-BR.json
```
