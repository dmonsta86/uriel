# Uriel Forge hero prompt — Español
...
Create a locale-specific ART-ONLY variation for Español (es).
...
Locale adaptation:
Pan-Hispanic master artisan with subtle Iberian filigree and Latin American metalwork warmth; no national costume, conquest, bullfighting, or religious clichés.
...
```text
globalization/image_copy/es.json
```
