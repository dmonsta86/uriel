...
Create a locale-specific ART-ONLY variation for 简体中文 (zh-Hans).
...
Locale adaptation:
East Asian male scholar-smith with restrained Han-inspired lamellar geometry, lacquer and bronze craft, and abstract manuscript/scientific motifs; no dragon, pagoda, imperial, or sacred-calligraphy clichés.
...
```text
globalization/image_copy/zh-Hans.json
```
