...
في فرع `main` المعتمد، يستطيع مسار `uriel data` المحلي التجريبي تخطيط ملفات CSV وTSV وJSON وJSONL والنص وMarkdown بترميز UTF-8 وختمها؛ وإنشاء ملفات تعريف بنيوية وأجيال غير قابلة للتغيير؛ ومعاينة الفروق؛ والحفاظ على كل سجل إدخال أثناء المطابقة؛ وإعادة تحليل الارتباط بالبيانات الخام والتحقق منه بصورة مستقلة. وهو لا ينفذ الصيغ، ولا يخمّن الوحدات أو الأنواع الدلالية، ولا ينشئ نتائج علمية، ولا يمنح صلاحية البوابة 0.
